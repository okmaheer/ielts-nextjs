// app/(admin)/(others-pages)/take-writing-tests/general-training/[testId]/instructions/page.tsx
...
export default function GeneralTrainingWritingTestInstructionsPage() {
  const params = useParams();
  const testId = params.testId as string;

  // Define instructions for general training writing test
  const writingInstructions = {
    testType: 'Writing' as const,
    category: 'General Training' as 'Academic' | 'General Training',
    duration: 60,
    ...
    startRoute: `/take-writing-tests/general-training/${testId}`,
  };
