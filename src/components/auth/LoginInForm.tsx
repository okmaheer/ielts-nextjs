...
export default function LoginInForm() {
  ...
  return (
    <div className="flex flex-col flex-1 lg:w-1/2 w-full bg-white dark:bg-gray-900">
      {/* Back Link */}
      <div className="w-full max-w-md sm:pt-4 mx-auto px-6">
        <Link
          href="/"
      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto px-6">
        <div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full inline-flex items-center justify-center gap-3 py-4 text-base font-medium text-white transition-all rounded-xl shadow-md hover:shadow-lg transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed"
            style={{
